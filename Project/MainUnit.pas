...
type
  ...
  TMainForm = class(TForm)
    ...
    procedure Plugins2Click(Sender: TObject);
...
resourcestring
  ...
  strClickToGoHome = 'Click here to go to the Forza Mods homepage';
  ...
  rsDoYouWantToGoToTheCheatEngineWebsite =
    'Do you want to go to the Forza Mods website?';
...
procedure TMainForm.Plugins2Click(Sender: TObject);
begin
...
var s: string;
begin
  ShellExecute(0,'open','https://forzamods.github.io/website/',nil,nil,SW_SHOW);
end;
